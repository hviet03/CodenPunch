...
<td colspan="4" style="font-size:20px;color:blue">
 Students Details</td></tr>
  ...
  <tr class="table-progress">
    ...
    <th>Password</th>
    <td><a href="change-password.php" class="auth-link text-black">Reset password?</a></td>
  </tr>
  <?php $cnt=$cnt+1;}} ?>
</table>
                  </div>
