...
<html lang="en">
  <head>
    ...
    <title>SMS|| Student Login Page</title>
    <!-- plugins:css -->
            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                <div class="brand-logo">
                  <img src="images/logo.svg"> <center>Student Login</center>
                </div>
                <h4><center>Access your class now</center></h4>
                <h6 class="font-weight-light"><center>For student register, contact your teacher<center></h6>
                <form class="pt-3" id="login" method="post" name="login">
                  ...
                  <div class="mb-2">
                    <a href="../index.php" class="btn btn-block btn-facebook auth-form-btn">
                      <i class="icon-social-home mr-2"></i> Home </a>
                  </div>
